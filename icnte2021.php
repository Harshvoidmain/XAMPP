...
The Conference received a wide response of 283 papers from authors in India and abroad for 14 different tracks. Out of 283 received papers, 189 papers were selected for presentation in the conference and the presented papers were sent to IEEE for possible inclusion into IEEE Xplore which is a Scopus Indexed digital library. Additionally, 20% of the selected papers were recommended for further review to IEEE Transactions in Industrial Applications.
  ...
  <div class="column">
      ...
      <img src="./images/21a.jpg" style=" width:100%;margin-bottom: 15px;"  onclick="openModal();currentSlide(1)" class="hover-shadow" >

  </div>

   <div class="column">

      <img src="./images/21b.jpg" style=" width:100%;margin-bottom: 15px;"  onclick="openModal();currentSlide(2)" class="hover-shadow" >

  </div>

   <div class="column">

      <img src="./images/21c.jpg" style=" width:100%;margin-bottom: 15px;"  onclick="openModal();currentSlide(3)" class="hover-shadow" >

  </div>

   <div class="column">

      <img src="./images/21e.jpg" style=" width:100%;margin-bottom: 15px;"  onclick="openModal();currentSlide(4)" class="hover-shadow" >

  </div>

     <div class="column">

      <img src="./images/21f.jpg" style=" width:100%;margin-bottom: 15px;"  onclick="openModal();currentSlide(5)" class="hover-shadow" >

  </div>

  <div class="column">

      <img src="./images/21d.jpg" style=" width:100%;margin-bottom: 15px;"  onclick="openModal();currentSlide(6)" class="hover-shadow" >

  </div>
  <div class="column">

      <img src="./images/21g.jpg" style=" width:100%;margin-bottom: 15px;"  onclick="openModal();currentSlide(6)" class="hover-shadow" >
