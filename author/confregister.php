					...
					<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="auname" id="name"  placeholder="Enter your name"/>
								</div>
							</div>
						</div>
		...
		<div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="auorg" id="Description"  placeholder="Organization you are affiliated to"/>
                </div>
              </div>
            </div>
		<div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-address-book fa" aria-hidden="true"></i></span>
                  <input type="text" class="form-control" name="auaddress" id="Description"  placeholder="Address"/>
                </div>
              </div>
            </div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								...
								<div class="row">
									...
									<div class="form-group col-xs-9"><input type="text" class="form-control" name="auphone" id=""  placeholder="Mobile Number"/>
								</div>
								</div>
							</div>
						</div></div>
		...
		<div class="form-group"><label for="password" class="cols-sm-2 control-label">Ph.D</label>
			<div class="cols-sm-10"><div class="input-group">
	         ...
	         <label class="radio-inline"><input type="radio" name="optradio" value="No"> No</label>
                     ...
                     <input type="password" class="form-control input-lg"name="password" placeholder="Password" class="textInput">
                  </div></div></div>
                  <div class="form-group"><label for="password" class="cols-sm-2 control-label">Password Again</label>
						<div class="cols-sm-10"><div class="input-group">
									<span class="input-group-addon"><i class="fa fa-archive fa" aria-hidden="true"></i></span>
                     <input type="password" class="form-control input-lg"name="password2" placeholder="Password again" class="textInput">
                  </div>
</div>
		</div>				<br><br>
						<div class="form-group ">
