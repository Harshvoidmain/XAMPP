...
/*$sql="SELECT rewid,rewname FROM reviewer WHERE trackid='$tids' AND sessionid='$sids'";
  ...
  */  
     ...
     $sql= "UPDATE papers SET rew1='$rew1', pstatus1='Under Review', rew2='$rew2', pstatus2='Under Review',rew3='$rew3', pstatus3='Under Review', opstatus='Under Review',DateAssigned = '$pdate' WHERE paperid='$paperid'";
...
require '../../PHPMailer-master/PHPMailerAutoload.php';
      ...
      $mail1 ->Port = 587; 
      $mail1 ->IsHTML(true);
      $mail1 ->Username = "icnte@fcrit.ac.in";
      $mail1 ->Password = "conf@2019";
      $mail1 ->SetFrom("icnte@fcrit.ac.in");
      $mail1->addAddress($rewemail1);
      $mail1->AddCC('icnte@fcrit.ac.in', 'ICNTE');    
      $mail1->Subject = 'Paper Assigned';
      $mail1->Body = nl2br("Dear Sir/Madam,
      ...
      else
      {
            ...
            header("location:sendr.php?assign=reviewer1no");
            // echo $result1;
            // echo error_message;
      }
      ...
      $mail2 ->Port = 587; 
      $mail2 ->IsHTML(true);
      $mail2 ->Username = "icnte@fcrit.ac.in";
      $mail2 ->Password = "conf@2019";
      $mail2 ->SetFrom("icnte@fcrit.ac.in");
      $mail2->addAddress($rewemail2);
      $mail2->AddCC('icnte@fcrit.ac.in', 'ICNTE');    
      $mail2->Subject = 'Paper Assigned';
      $mail2->Body = nl2br("Dear Sir/Madam,
			At the outset accept our greetings of the day.
      ...
      else
      {
            ...
            header("location:sendr.php?assign=reviewer2no");
            // echo $result1;
            // echo error_message;
      }
      ...
      $mail3 ->SMTPDebug = 0;
      $mail3 ->SMTPAuth = true;
      $mail3 ->SMTPSecure = 'STARTTLS';
      $mail3 ->Host = "smtp.office365.com";
      $mail3 ->Port = 587; 
      $mail3 ->IsHTML(true);
      $mail3 ->Username = "icnte@fcrit.ac.in";
      $mail3 ->Password = "conf@2019";
      $mail3 ->SetFrom("icnte@fcrit.ac.in");
      $mail3->addAddress($rewemail3);
      $mail3->AddCC('icnte@fcrit.ac.in', 'ICNTE');    
      $mail3->Subject = 'Paper Assigned';
      $mail3->Body = nl2br("Dear Sir/Madam,
			At the outset accept our greetings of the day.
      ...
      else
      {
            ...
            echo "Error " .$mail3->ErrorInfo;
            header("location:sendr.php?assign=reviewer3no");
            // echo $result1;
            // echo error_message;
      }
...
// 			ICNTE 2021 website whose link is given below.
// 			https://icnte.fcrit.ac.in/login.php
// 			Your Login Details were given in the registration email.If you have forgotten your password, you can clcikcon forgot password link.New password will be mailed to you.
