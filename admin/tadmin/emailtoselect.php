...

  {
     ...
     $sql="SELECT auemail from author WHERE auid IN (
              SELECT auid from papers WHERE trackid IN(
                     SELECT tid FROM tracks WHERE dept= '$dept') AND ( (pstatus1='Accepted' AND pstatus2='Accepted') OR (pstatus2='Accepted' AND pstatus3='Accepted') OR (pstatus1='Accepted' AND pstatus3='Accepted') ) )";
            ...
            <div class="row" style="padding:0 !important;">
                <div class="col-md-12" style="padding:0 !important;">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript::">Email to Accepted Paper</a></li>
                    </ol>
                </div>
            </div>
        </div>
...
<div class="row">
    ...
    <h2 style="text-align:center;">Email To Accepted Paper</h2>
