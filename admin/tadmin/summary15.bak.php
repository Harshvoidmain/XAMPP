...
$sqlRew="SELECT * FROM reviewer WHERE dept='$dept';";
$resultRew = mysqli_query($db, $sqlRew);

//Form array of reviewer and do foreach loop in the front end and make a function which fetches the paper details for the corresponding reviewer. 

//$result=mysqli_query($db,$sql);

// $sql="SELECT * FROM reviewer,papers WHERE papers.dept='$dept' and reviewer.rewid in(rew1,rew2,rew3)";
$sql="SELECT * FROM reviewer,papers WHERE papers.dept='$dept' ";
