...
$result=mysqli_query($db,'SELECT paperid, auid, opstatus, ptitle, trackid, sessionid, pfilename FROM papers WHERE sessionid=0');
//
$ses=mysqli_query($db,'SELECT * FROM sessions');
