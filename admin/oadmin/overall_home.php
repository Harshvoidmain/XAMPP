...
$sql="SELECT * FROM tracks WHERE dept='hmnts'";
...
<div class="row">
 ...
 echo '';
 				while($row = mysqli_fetch_array($result1))
 				{
					...
					{
						$sid=$row['sid'];						
					$r5=mysqli_query($db,"SELECT trackid , COUNT(*) as number FROM papers WHERE trackid='$tid' AND sessionid='$sid' AND opstatus='not assigned' "); 
					$data=mysqli_fetch_array($r5);
					$r6=mysqli_query($db,"SELECT trackid , COUNT(*) as number FROM papers WHERE trackid='$tid' AND sessionid='$sid'"); 
					$data1=mysqli_fetch_array($r6);
					echo "<td>".$data['number']."/".$data1['number']."</td>";
...
<div class="graph">
     ...
     <br>
	 <center><h4 style="font-size:"><b>Humanities and Basic Sciences Department</b></h4></center>
<div class="row">
    <div class="col-md-6" style="padding: 20px;border-right: 1px solid lightskyblue;">
        <div> 
        <table class="table" style="border-collapse: collapse;" style="width:100%" border="1" Cellpadding = "5">
...
<script>  
 ...
 <div id="piechart14" style="width: 900px; height: 420px;"></div>
	</div>
