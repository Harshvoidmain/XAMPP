            ...
            <div class="header-top " style="position:absolute;top:5px;left:0;height:150px;">
              <div class="col-md-2">  
                <div class="" style="font-family:'Cinzel', serif;color: #555;height:100%;float:left;font-size:60px;padding:12px;">
                   ...
                   <span style="font-family:'Cinzel', serif; color: #555;   vertical-align:central;height:100%;float:left;font-size:60px;padding-left:16%;padding-right:50%;padding-top:15px;padding-bottom: 20px;">2021</span>
                 </div>
                ...
                <div class="title visible-lg" style="float: left; display:inline-block;text-transform: none; margin-top: 25px" >
                    ...
                    <p style="text-align: left;margin:0px;word-spacing: 2px;font-weight:600;">     January 15-16, 2021  </p>
                </div>
