...
class PDF extends FPDF
   ...
   $pdf->SetFont('Arial','B',11);
		...
		$pdf->Cell(95,10,'Phone',1,0,'C',true);
...
$result1=mysqli_query($db,$sql);
	...
	while($data=mysqli_fetch_array($result1)){
		$pdf->Ln(10);
		$pdf->Cell(95,10,$data['auname'],1,0,"C");
		$pdf->Cell(95,10,$data['auphone'],1,0,"C");
            ...
            <div class="row" style="padding:0 !important;">
                <div class="col-md-12" style="padding:0 !important;">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="summary8.php">Author Details[Name,Mob]</a></li>
...
<div class="container"> 
<br/><br/>
 <form class="form-group" method="post" action="summary8.php">
