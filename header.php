  ...
  <nav class="bg-blue-900 text-white shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4">
      <div class="flex justify-between items-center py-4">
        <!-- Logo Left -->
        <img src="images/icntelogoinverted.png" alt="ICNTE Logo" class="w-12 h-12 md:w-16 md:h-16" />
        ...
        <!-- Logo Right -->
        <img src="images/clglogoinverted.png" alt="College Logo" class="w-12 h-12 md:w-16 md:h-16" />
      </div>
