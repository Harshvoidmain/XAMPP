...
require "connection.php";
   ...
   if(isset($_POST['rlogin_btn']))
   {
	   $email=mysqli_real_escape_string($db,$_POST['email']);
       $password=mysqli_real_escape_string($db,$_POST['password']);
       $passwordmd5=md5($password); //hashing password  //DO NOT CHANGE THIS.
       $sql="SELECT * FROM reviewer WHERE email='$email' AND rpassword='$password' OR rpassword='$passwordmd5'";
	...
	//    echo "hi";
      ...
      else
      {
        //    $_SESSION['messag']="Username and Password combination incorrect";
           header("location:login.php?combo=bad");
		//echo $email ;
		//echo $password;
      }
   }
 ...
 <div class="col-md-6" style="height:500px;display:table;margin-top:10px;" id="activediv">
    <?php
        if(isset($_GET['status'])){
            echo '
            <div style="display: flex;flex-direction: column;height: 300px;justify-content: center;margin-left: 10%;">
            <div class="panel" style="font-size: 20px;background: lightgreen;color: snow;">
            <div class="panel-heading" style="font-size:20px"><center>Registered successfully! </center><div style="font-size: 16px;"><center>Check your registered email for details.</center></div></div>
            </div>
            </div>';
        }
        ...
        if(isset($_GET['combo'])){
            echo '<div class="panel panel-danger" id="close6">
                    <div class="panel-heading" style="font-size:16px">Incorrect E-mail and password combination. If you have forgotten your password, kindly click on Forgot Password under Reviewer Login<button type="button" class="close" data-target="#close6" data-dismiss="alert">
  ...
  <div class="login-container">
            ...
            <div class="form-box">
                <form method="post" action="login.php">
                    ...
                    <input type="password" name="password" placeholder="password">
                    <button class="btn btn-info btn-block login" type="submit" name="login_btn">Login</button>
					<div class="col-md-12" style="margin-top:0px;display:flex;">
                        <!-- <div class="col-md-6" >  -->
