    ...
    <div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
        ...
        <div class="portlet box grey">
            <div class="portlet-title">
                <div class="caption"><i class="icon-user"></i><?php echo __('Home Banner Images'); ?></div>
                <div class="actions">
                    <?php if($this->Permissions->hasAccess($this->name, 'add')){?>
	                    <?php echo $this->Html->link('<i class="icon-plus"></i> Add '.__('Home Banner Image'),array('action'=>'add'), array('class'=>'btn blue', 'escape'=>FALSE));?>
                    <?php } ?>
                    <div class="btn-group">
                ...
                <div role="grid" class="dataTables_wrapper form-inline" id="sample_2_wrapper">
                    ...
                    <div class="dataTables_scrollBody" style="overflow: auto; width: 100%;">
                        <table id="sample_2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_2_info">
                            <thead>
                                <tr class="row">
                                    <th style="width:8px;"><input type="checkbox" class="group-checkable" data-set="#sample_2 .checkboxes" /></th>
                                                                            ...
                                                                            <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('heading'); ?></th>
                                                                            <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('description'); ?></th>
                                                                            <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('url_heading'); ?></th>
                                                                            <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('url'); ?></th>
                            ...
                            <tbody>
                                <?php foreach ($homeBannerImages as $homeBannerImage): ?>
	<tr class="odd gradeX row">
		<td><input type="checkbox" class="checkboxes" value="<?php echo h($homeBannerImage['HomeBannerImage']['id']); ?>" /></td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['id']); ?>&nbsp;</td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['file']); ?>&nbsp;</td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['heading']); ?>&nbsp;</td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['description']); ?>&nbsp;</td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['url_heading']); ?>&nbsp;</td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['url']); ?>&nbsp;</td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['created_by']); ?>&nbsp;</td>
		<td class="hidden-480"><?php echo h($homeBannerImage['HomeBannerImage']['created_timestamp']); ?>&nbsp;</td>
		<td class="actions hidden-480">
<?php if($this->Permissions->hasAccess($this->name, 'view')){?>
				<?php echo $this->Html->link(__('<i class="icon-eye-open"></i> View'), array('action' => 'view', $homeBannerImage['HomeBannerImage']['id']), array('class'=>'btn purple','escape'=>false)); ?>
<?php } ?>
<?php if($this->Permissions->hasAccess($this->name, 'edit')){?>
				<?php echo $this->Html->link(__('<i class="icon-pencil"></i> Edit'), array('action' => 'edit', $homeBannerImage['HomeBannerImage']['id']), array('class'=>'btn green','escape'=>false)); ?>
<?php } ?>
<?php if($this->Permissions->hasAccess($this->name, 'delete')){?>
				<?php echo $this->Form->postLink(__('<i class="icon-trash"></i> Delete'), array('action' => 'delete', $homeBannerImage['HomeBannerImage']['id']), array('class'=>'btn red','escape'=>false), __('Are you sure you want to delete # %s?', $homeBannerImage['HomeBannerImage']['id'])); ?>
<?php } ?>
		</td>
	</tr>
<?php endforeach; ?>
