...
/**
    ...
    */
    ...
    $this->Session->setFlash(__('Invalid winner'), 'flash_warning');
    ...
    */
    ...
    if ($this->Winner->save($this->request->data)) {
            $this->Session->setFlash(__('The winner has been saved'),'flash_success');
        $this->redirect(array('action' => 'index'));
        } else {
            $this->Session->setFlash(__('The winner could not be saved. Please, try again.'),'flash_error');
        }
    }
        }
    ...
    */
    ...
    if ($this->Winner->delete()) {
            $this->Session->setFlash(__('Winner deleted'),'flash_success');
        $this->redirect(array('action' => 'index'));
        }
            $this->Session->setFlash(__('Winner was not deleted'),'flash_error');
        $this->redirect(array('action' => 'index'));
    }
