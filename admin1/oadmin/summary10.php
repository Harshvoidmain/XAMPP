...
class PDF extends FPDF
   ...
   $pdf->Cell(190,16," Author List",1,1,"C");
   						
   $pdf->SetFont('Arial','B',11);
		$pdf->SetFillColor(51,197,255);
		$pdf->SetDrawColor(0,0,0);
		$pdf->Cell(45,10,'Name',1,0,'',true);
		$pdf->Cell(45,10,'Phone',1,0,'',true);
		$pdf->Cell(100,10,'Email',1,0,'',true);
...
$result1=mysqli_query($db,$sql);
	...
	while($data=mysqli_fetch_array($result1)){
		...
		$pdf->Cell(45,10,$data['auphone'],1,0);
		$pdf->Cell(100,10,$data['auemail'],1,0);
            ...
            <div class="row" style="padding:0 !important;">
                <div class="col-md-12" style="padding:0 !important;">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="summary10.php">Author Details[Name,Mob,Email]</a></li>
...
<div class="container"> 
<br/><br/>
 <form class="form-group" method="post" action="summary10.php">
