...
class PDF extends FPDF
   ...
   $pdf->SetFont('Arial','',10);
		...
		$pdf->Cell(30,10,'Name',1,0,'',true);
		$pdf->Cell(30,10,'Role',1,0,'',true);
		$pdf->Cell(22,10,'Phone',1,0,'',true);
		$pdf->Cell(25,10,'Country',1,0,'',true);
		$pdf->Cell(25,10,'State',1,0,'',true);
		$pdf->Cell(100,10,'Address',1,0,'',true);
...
$result1=mysqli_query($db,$sql);
	...
	while($data=mysqli_fetch_array($result1)){
		$pdf->Ln(10);
		$pdf->Cell(30,10,$data['auname'],1,0);
		$pdf->Cell(30,10,$data['aucategory'],1,0);
		$pdf->Cell(22,10,$data['auphone'],1,0);
		$pdf->Cell(25,10,$data['aucountry'],1,0);
		$pdf->Cell(25,10,$data['austate'],1,0);
		$pdf->Cell(100,10,$data['auaddress'],1,0);
            ...
            <div class="row" style="padding:0 !important;">
                <div class="col-md-12" style="padding:0 !important;">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="summary6.php">Author summary[All details]</a></li>
...
<div class="container"> 
<br/><br/>
 <form class="form-group" method="post" action="summary6.php">
