...
class PDF extends FPDF
   ...
   $sesid=mysqli_query($db,"SELECT * FROM sessions WHERE tid='$tid'");
	while($res=mysqli_fetch_array($sesid)){
		...
		$pdf->Cell(205,10,'Paper Title',1,0,'',true);
		$pdf->Cell(35,10,'Status',1,0,'',true);
...
//$sql="SELECT pid, auid, pstatus, ptitle, trackid, sessionid, pfilename FROM papers WHERE sessionid='$row->sid' ";
		...
		$pdf->Cell(205,10,$data['ptitle'],1,0);
		if($data['opstatus']=='Reviewed'){$pdf->Cell(35,10,'Decision Pending',1,0);}
					else{$pdf->Cell(35,10,$data['opstatus'],1,0);}
...
<html lang="en">
    ...
    <div class="">
        <div class="" style="margin-left:0 !important;padding:0 !important;margin-right:0 !important;">
            <div class="row" style="padding:0 !important;">
                <div class="col-md-12" style="padding:0 !important;">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="summary1.php">Track-wise Paper summary</a></li>
	 	...
	 	<center><h2><label  class="label" name="rew1done" value="" style="color:black">Papers Submitted Track Wise</label></h2></center>

<div class="container"> 
<br/><br/>
 <form class="form-group" method="post" action="summary1.php">
