...
class CakeNumber {
    ...
    protected static $_currencies = array(
        ...
        'INR' => array(
            'wholeSymbol' => 'INR ', 'wholePosition' => 'before', 'fractionSymbol' => 'p', 'fractionPosition' => 'after',
            'zero' => 0, 'places' => 2, 'thousands' => ',', 'decimals' => '.', 'negative' => '(-)', 'escape' => false
        ),
        'EUR' => array(
     ...
     * @var string
     */
    protected static $_defaultCurrency = 'INR ';
    ...
    public static function frmt($value) {
        return CakeNumber::currency($value, '', array(
                    'places' => 0,
                    'before' => '',
                    'escape' => false,
                    'decimals' => '.',
