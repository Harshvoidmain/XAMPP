...
/* This is the page where the overall decision of the paper is sent to the authors as well as saved in the database
     @author: sinimol
   */ 
$dept=$_SESSION['id'];
...
</select>--><br>   <form action="overall.php" method="post"> 
