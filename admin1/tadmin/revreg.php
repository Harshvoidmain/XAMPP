   ...
   if(isset($_POST['fillup']))
{
	...
	if(empty($salutation)||empty($rewname)||empty($qualification)||empty($organization)||empty($department)||empty($experience)||empty($trackid)||empty($sessionid)||empty($email)||empty($mobile)||empty($permanent))
		{
...
$mailMsg = nl2br("Dear Sir/Madam,
			...
			Thanks for accepting our invitation for reviewing the papers of ICNTE 2019 and registering yourself for the same. You have created your Reviewer’s Account. You can access the Account by clicking on the Login button available on the Home Page of the ICNTE 2019 website whose link is given below. 
			...
			For more information or any query contact the Technical Program Committee through Contact Us tab given on the Home Page of the ICNTE 2019 website. 
      ...
      <div id="wrapper" class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
             <br>  <h1 class="text-center" style="font-size:16px" >Add Reviewer</h1>
            ...
            <div id="frm" class="modal-body">
                ...
                ?>
				  <form method="post" action="overall.php" class="col-md-12 center-block">
