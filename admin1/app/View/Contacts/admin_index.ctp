    ...
    <div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
        ...
        <div class="portlet box grey">
            <div class="portlet-title">
                <div class="caption"><i class="icon-user"></i><?php echo __('Contacts'); ?></div>
                <div class="actions">
                        ...
                        <table id="sample_2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_2_info">
                            <thead>
                                <tr class="row">
                                    ...
                                    <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('email'); ?></th>
                                    <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('phone'); ?></th>
                                    <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('company'); ?></th>
                                    <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('message'); ?></th>
                            ...
                            <tbody>
                                <?php foreach ($contacts as $contact): ?>
                                    <tr class="odd gradeX row">
                                        <td><input type="checkbox" class="checkboxes" value="<?php echo h($contact['Contact']['id']); ?>" /></td>
                                        <td class="hidden-480"><?php echo h($contact['Contact']['id']); ?>&nbsp;</td>
                                        <td class="hidden-480"><?php echo h($contact['Contact']['name']); ?>&nbsp;</td>
                                        <td class="hidden-480"><?php echo h($contact['Contact']['email']); ?>&nbsp;</td>
                                        <td class="hidden-480"><?php echo h($contact['Contact']['phone']); ?>&nbsp;</td>
                                        <td class="hidden-480"><?php echo h($contact['Contact']['company']); ?>&nbsp;</td>
                                        <td class="hidden-480"><?php echo h($contact['Contact']['message']); ?>&nbsp;</td>
                                        <td class="actions hidden-480">
                                            <?php if ($this->Permissions->hasAccess($this->name, 'view')) { ?>
                                                <?php echo $this->Html->link(__('<i class="icon-eye-open"></i> View'), array('action' => 'view', $contact['Contact']['id']), array('class' => 'btn purple', 'escape' => false)); ?>
                                            <?php } ?>
                                            
                                            <?php if ($this->Permissions->hasAccess($this->name, 'delete')) { ?>
                                                <?php echo $this->Form->postLink(__('<i class="icon-trash"></i> Delete'), array('action' => 'delete', $contact['Contact']['id']), array('class' => 'btn red', 'escape' => false), __('Are you sure you want to delete # %s?', $contact['Contact']['id'])); ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
