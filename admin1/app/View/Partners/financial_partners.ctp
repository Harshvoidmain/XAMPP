            ...
            <div class="row" style="padding:0 !important;">
                <div class="col-md-12" style="padding:0 !important;">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Financial Partners</li>
                    </ol>
                </div>
            </div>
        </div>
...
<div class="container">
    <?php foreach($finspon as $fins ) { ?>
    <div class="col-md-3" style="padding:10px;">
        <div style="border:1px solid #2bbafc;border-radius:20px;padding:10px;min-height: 289px;">
        <div style="width:100%">
            <?php echo $this->Html->image($fins['Company']['image'],array('style' => 'width:100%;height:100%')); ?>
        </div>
        <!--div style="width:100%;text-align: center;">
            <?php echo $fins['Company']['name']; ?>
        </div-->
        </div>
    </div>
    <?php } ?>
