    ...
    <div class="span12">
        <div class="portlet box blue ">
            <div class="portlet-title">
                <div class="caption"><i class="icon-reorder"></i> <?php echo __('Add Admin'); ?></div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                ...
                echo $this->Form->input('password', array('class' => 'star_required'));
                echo $this->Form->input('confirm_password', array('type' => 'password', 'class' => 'star_required'));
