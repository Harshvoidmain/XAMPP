                        ...
                        <table id="sample_2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_2_info">
                            <thead>
                                <tr class="row">
                                    ...
                                    <th class="hidden-480 sorting" style="width: 500px;"><?php echo $this->Paginator->sort('description'); ?></th>
                                    <th class="hidden-480 sorting"><?php echo $this->Paginator->sort('active_till'); ?></th>
                            ...
                            <tbody>
                                <?php foreach ($latestNews as $latestNews): ?>
                                    <tr class="odd gradeX row">
                                        ...
                                        <td class="hidden-480"><?php echo h($latestNews['LatestNews']['active_till']); ?>&nbsp;</td>
