    ...
    <div class="portlet-body form">
        ...
        <div class="form-horizontal form-view">
            ...
            <div class="row-fluid">
                <div class="span6 ">
                    <div class="control-group">
                        <label class='control-label' for='Attachment'><?php echo __($this->Common->get_view_chage_log('LatestNews', 'attachment', $latestNews['LatestNews']['id']) . 'Attachment'); ?></label>
                        <div class='controls'>
                            <span class='text'>
                                <?php echo $this->Common->get_button($latestNews['LatestNews']['attachment'], NULL); ?>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row-fluid">
                <div class="span6 ">
                    <div class="control-group">
                        <label class='control-label' for='ActiveTill'><?php echo __($this->Common->get_view_chage_log('LatestNews', 'active_till', $latestNews['LatestNews']['id']) . 'Active Till'); ?></label>
                        <div class='controls'>
                            <span class='text'>
                                <?php echo h($latestNews['LatestNews']['active_till']); ?>
                            </span>
                        </div>
                    </div>
                </div>
