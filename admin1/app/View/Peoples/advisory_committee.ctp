...
<div class="container">
    <h2 style="text-align: center;">Advisory Committees</h2>
    <hr class="style17">
</div>
<div class="">
    <table class="table table-striped table-inverse " style="text-align: center;vertical-align: middle;margin:10px;">
        <thead>
        <tr>
...
<!--      <th  style="text-align: center;vertical-align: middle;width:20%;">Role</th>-->
    ...
    <tr>
      ...
      <td><?php echo $committee['AdvisoryCommittee']['name']; ?></td>
      <td><?php echo $committee['AdvisoryCommittee']['designation']; ?></td>
      <td><?php echo $committee['AdvisoryCommittee']['institute']; ?></td>
<!--      <td><?php echo $committee['AdvisoryCommittee']['role']; ?></td>-->
