    ...
    <div class="portlet-body form">
        ...
        <div class="form-horizontal form-view">
            ...
            <div class="row-fluid">
                ...
                <div class="span6 ">
                    <div class="control-group">
                        <label class='control-label' for='Sr_no'><?php echo __($this->Common->get_view_chage_log('OrganizingCommittee', 'sr_no', $organizingCommittee['OrganizingCommittee']['sr_no']) . 'Sr_no'); ?></label>
                        <div class='controls'>
                            <span class='text'>
                                <?php echo h($organizingCommittee['OrganizingCommittee']['sr_no']); ?>
                            </span>
                        </div>
                    </div>
                </div>
