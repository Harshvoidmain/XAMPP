    ...
    root = this, $ = jQuery, $.fn.extend({chosen: function(options) {
        ...
        return __extends(Chosen, _super), Chosen.prototype.setup = function() {
            ...
            if (this.form_field_jq.attr("tabindex"))
                return ti = this.form_field_jq.attr("tabindex"), this.form_field_jq.attr("tabindex", -1), this.search_field.attr("tabindex", ti)
            ...
            if (target.length)
                return this.result_highlight = target, this.result_select(evt), this.search_field.focus()
...
(function($) {
    return $.fn.ajaxChosen = function(settings, callback, chosenOptions) {
        ...
        defaultOptions = {minTermLength: 3, afterTypeDelay: 500, jsonTermKey: "q", keepTypingMsg: "Keep typing...", lookingForMsg: "Looking for"};
        select = this;
        chosenXhr = null;
