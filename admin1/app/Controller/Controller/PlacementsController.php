...
/**
    ...
    */
    ...
    if (!$this->Placement->exists($id)) {
    $this->Session->setFlash(__('Invalid placement'), 'flash_warning');
    $this->redirect($this->referer());
    }
    $options = array('conditions' => array('Placement.' . $this->Placement->primaryKey => $id));
    $this->set('placement', $this->Placement->find('first', $options));
    }
    ...
    */
    ...
    if ($this->Placement->save($this->request->data)) {
            $this->Session->setFlash(__('The placement has been saved'),'flash_success');
        $this->redirect(array('action' => 'index'));
        } else {
            $this->Session->setFlash(__('The placement could not be saved. Please, try again.'),'flash_error');
        }
    }
        }
    ...
    */
    ...
    $options = array('conditions' => array('Placement.' . $this->Placement->primaryKey => $id));
    $this->request->data = $this->Placement->find('first', $options);
    }
        }
    ...
    */
    ...
    if ($this->Placement->delete()) {
            $this->Session->setFlash(__('Placement deleted'),'flash_success');
        $this->redirect(array('action' => 'index'));
        }
            $this->Session->setFlash(__('Placement was not deleted'),'flash_error');
        $this->redirect(array('action' => 'index'));
    }
